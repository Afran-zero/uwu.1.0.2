<?php if(isset($_SESSION['Auth'])){ ?>
    <div class="modal fade custom-modal" id="addpost" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="my-3 position-relative">
            <label for="select_post_img" class="custom-file-label">Choose Image</label>
            <input class="form-control custom-input visually-hidden" name="post_img" type="file" id="select_post_img">
        </div>

          <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Say Something</label>
            <textarea name="post_text" class="form-control custom-input" id="exampleFormControlTextarea1" rows="1"></textarea>
          </div>
          <button type="submit" class="btn btn-primary custom-btn">Post</button>
        </form>
      </div>
    </div>
  </div>
