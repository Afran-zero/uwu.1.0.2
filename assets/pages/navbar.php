<?php global $user;?>
    <nav class="navbar navbar-expand-lg navbar-light bg-dark border">
...
<form class="d-flex w-100" id="searchform" style="max-width: 600px; position: relative;">
    <input 
    ...
    >
    <div 
        class="bg-white text-end rounded border shadow py-3 px-4 mt-1" 
